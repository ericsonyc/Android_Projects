...
import com.android.androidpacman.app.entity.CutsceneActor.Cutscene.Move;
import com.android.androidpacman.app.entity.CutsceneActor.Cutscene.StartPoint;
...
public class CutsceneBlinky extends CutsceneActor {
    ...
    void setMode(Cutscene cutscene) {
        Sequence s =
                (Sequence) cutscene.sequences[game.getCutsceneSequenceId()];
        mode = s.mode;
